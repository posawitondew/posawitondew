...
<body>
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="login.php" class="navbar-brand px-lg-4 m-0">
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 600px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Data Pupuk</h1>
            <div class="d-inline-flex mb-lg-5">
                <p class="m-0 text-white"><a class="text-white" href="">Hasil</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Data Pupuk</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="list-produk">
            <img src="PupukUrea.PNG" alt="Pupuk Mop">
  
            <h4>Pupuk Urea</h4>
  
            <center><a class="tombol tombol-detail" href="PupukUrea.php">Detail</a></center>
        </div>
  
        <div class="list-produk">
            <img src="PupukNPK.PNG" alt="Pupuk Organik">
  
            <h4>Pupuk NPK</h4>

            <a class="tombol tombol-detail" href="PupukNPK.php">Detail</a> 
			
        </div>
  
        <div class="list-produk">
            <img src="PupukOrganik.PNG" alt="Pupuk">
  
            <h4>Pupuk Organik</h4>
  
            <a class="tombol tombol-detail" href="PupukOrganik.php">Detail</a> 
        </div>
    </div>
        </div>
    </div>
