...
// ambil data (query) dari tabel kriteria
...
<body>
	...
	<a href="tambahdata_kriteria.php"> Tambah Data</a>
	<br>
	<br>
	...
	<center><table border="1" cellpadding="10" cellspacing="0">
		...
		<?php $no = 1; ?>
		<?php foreach ($kriteria as $kr) :$no++; ?>
		<tr>
			<td> <?= $no++ ?></td>
			<td> <?=$kr["kriteria"]; ?> </td>
			<td> <?=$kr["jenis"]; ?> </td>
			<td> <?=$kr["bobot"]; ?> </td>
			 <td><a href="editkriteria.php?id=<?= $kr ["id"]; ?> ">Edit</a> | <a href="hapus_kriteria.php?id=<?= $kr ["id"]; ?> " onclick= "return confirm ('Anda yakin ingin mengapus data ini?')" >Hapus</a></td>
		</tr>
		<?php $no++; ?>
		<?php endforeach ; ?>
	</table></center>
