    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 600px">
            ...
            <div class="d-inline-flex mb-lg-5">
                ...
                <p class="m-0 text-white">Pupuk NPK</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
  ...
  <!-- Service Start -->
    ...
    <table>
        <tr>
            <td>
                <!--untuk gambar produk-->
                <img src="PupukNPK.png" width="265">
            </td>
            <td>
                <!--untuk deksripsi produk-->
                <h4>Deskripsi Produk:</h4>
                <p>Pupuk NPK adalah pupuk yang memiliki kandungan tiga unsur hara makro yaitu Nitrigen(N) Fosfor(P) dan Kalium</p>
                <p>Manfaat Pupuk NPK secara umum adalah membantu Pertumbuhan tanaman agar berkembang secara maksimal</p>
    </table>
        </div>
    </div>
    <!-- Service End -->
