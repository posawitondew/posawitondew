...
<body>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 600px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Pupuk </h1>
            <div class="d-inline-flex mb-lg-5">
                <p class="m-0 text-white"><a class="text-white" href="">Data Pupuk</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Pupuk Organik</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
  ...
  <!-- Service Start -->
    ...
    <table>
        <tr>
            <td>
                <!--untuk gambar produk-->
                <img src="PupukOrganik.png" width="265">
            </td>
            <td>
                <!--untuk deksripsi produk-->
                <h2>Deskripsi Produk:</h2>
                <p>Merupakan pupuk tinggi dengan kandung Nitrogen(N) 55% sampai 56%</p>
                <p>Yang bermanfaat dalam proses pertumbuhan dan perkembangan tanaman</p>
                <p>Manfaat lainnya adalah pupuk urea yang membuat daun tanaman lebih hijau dan segar</p>
    </table>
        </div>
    </div>
    <!-- Service End -->
