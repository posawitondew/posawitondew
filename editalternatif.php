...
$id = $_GET["id"];
//query data alternatif berdasarkan id
$alt = query ("SELECT * FROM alternatif WHERE id = $id") [0];
//query data alternatif
if ( isset($_POST["submit"]) ) {
    ...
    if ( ubah($_POST) > 0) {
        ...
        document.location.href = 'editalternatif.php';
        </script>";
    }
}
?>
...
<form action="" method="POST">
        <table>
            <input type="hidden" name="id" value="<?= $alt["id"]; ?>"></td>
            <tr>
            <td>Alternatif</td> <td>:</td> <td> <input type="text" name="alternatif" value="<?= $alt["alternatif"]; ?>"></td>
            </tr>
             <tr>
            <td>Keterangan</td> <td>:</td> <td> <input type="text" name="keterangan" value="<?= $alt["keterangan"]; ?>"></td>
            </tr>
