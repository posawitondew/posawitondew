...
if( isset($_POST["submit"])) {
    ...
    if (tambah($_POST) > 0 ) {
        ...
        document.location.href = 'tambahdata_alternatif.php';
        </script>";
    }
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 600px">
            ...
            <div class="d-inline-flex mb-lg-5">
                <p class="m-0 text-white"><a class="text-white" href="">Tambah Data</a></p>
...
<form action="" method="post">
        <table>
            <tr> 
                <td>Alternatif</td> 
                <td> : </td> 
                <td><input type="text" name="alternatif"Required oninvalid="this.setCustomValidity('Alternatif tidak boleh kosong')" oninput="setCustomValidity('')"/></td>
            </tr>
			<tr>
                <td>Keterangan</td> 
                <td> : </td> 
                <td><input type="text" name="keterangan"Required oninvalid="this.setCustomValidity('Keterangan tidak boleh kosong')" oninput="setCustomValidity('')"/></td>
            </tr>
            <tr>
