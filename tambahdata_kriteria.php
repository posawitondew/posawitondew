...
if( isset($_POST["submit"])) {
    ...
    if (tambah($_POST) > 0 ) {
        ...
        document.location.href = 'tambahdata_kriteria.php';
        </script>";
    }
...
<form action="" method="post">
        <table>
            <tr> 
                <td>Kriteria</td> 
                <td> : </td> 
                <td><input type="text" name="kriteria"Required oninvalid="this.setCustomValidity('Kriteria tidak boleh kosong')" oninput="setCustomValidity('')"/></td>
            </tr>
			<tr>
                <td>Jenis</td> 
                <td> : </td> 
                <td><input type="text" name="jenis"Required oninvalid="this.setCustomValidity('Jenis tidak boleh kosong')" oninput="setCustomValidity('')"/></td>
            </tr>
			<tr> 
                <td>Bobot</td> 
                <td> : </td> 
                <td><input type="text" name="bobot"Required oninvalid="this.setCustomValidity('Bobot tidak boleh kosong')" oninput="setCustomValidity('')"/></td>
            </tr>
			<tr>
